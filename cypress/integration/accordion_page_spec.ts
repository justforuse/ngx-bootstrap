...
describe('Accordion page test suite', () => {
  ...
  it('first and third panel at styling accordion contains customClass style', () => {
    accordion.getAccordionPanel(accordionExamples[4], 0).children('.card')
      .should('have.class', 'customClass');
    accordion.getAccordionPanel(accordionExamples[4], 1).children('.card')
      .should('not.have.class', 'customClass');
    accordion.getAccordionPanel(accordionExamples[4], 2).children('.card')
      .should('have.class', 'customClass');
  });
